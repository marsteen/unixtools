...
/****  "normal" letters (A-Z)  ****/
    ...
    "ERREGEND-----",   " ER",     " ER",
    "ERT1$",           "ERT",      null,
    "ER(DGLKMNRQTZß)-", "ER",    null,
    "ER(AÄEÈÉÊIÌÍÎOÖUÜY)-", "ER", "A",
    "ER1$",            "ER",       "A",
    "ER<1",            "ER",       "A",
    "ETAT7",           "ETA",     "ETA",
    "ETI(AÄOÖÜU)-",    "EZI",     "EZI",
    ...
    "TRAINI-",         "TREN",    "TREN",
    "TRÄCHTI-^",       "TRAECHT",  "TREKT",
    "TRÄCHTIG--",      " TRAECHT", " TREKT",
    "TSCH",            "SH",      "Z",
    "TSH",             "SH",      "Z",
    "TST",             "ZT",      "ZT",
    "T(Sß)",           "Z",       "Z",
